...
- **2026-08-02 addendum**: added User Story 6, FR-021–FR-024, and SC-010–012 to push the already-implemented visual system toward a more futuristic, dynamic feel per the maintainer's request. Re-validated against all checklist items — no [NEEDS CLARIFICATION] markers introduced; new requirements reuse the existing "reduce motion" / Lighthouse 90+ constraints (FR-013) rather than prescribing implementation. All checklist items remain passing.
